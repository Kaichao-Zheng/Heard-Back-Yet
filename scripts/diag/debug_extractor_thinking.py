...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Debug one entity-extraction Ollama call and show thinking/content chunks."
    )
    parser.add_argument(
        "json_path",
        nargs="?",
...
def main() -> None:
    ...
    print("task=entities")
    print("prompt=extract_entities.build_prompt")
    ...
    try:
        ...
        validated = validate_extraction(parsed, args.model, record)
